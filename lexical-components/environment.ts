...
export const IS_FIREFOX: boolean = /^(?!.*Seamonkey)(?=.*Firefox).*/i.test(navigator.userAgent);
...
export const IS_SAFARI: boolean = /Version\/[\d.]+.*Safari/.test(navigator.userAgent);
...
export const IS_APPLE_WEBKIT = /AppleWebKit\/[\d.]+/.test(navigator.userAgent) && !IS_CHROME;
