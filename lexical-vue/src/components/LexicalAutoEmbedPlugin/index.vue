...
import type { CommandListenerPriority, MutationListener, NodeKey, TextNode } from 'lexical';

import { $isLinkNode, AutoLinkNode, LinkNode } from '@lexical/link';

import { $getNodeByKey, $getSelection, COMMAND_PRIORITY_EDITOR } from 'lexical';
...
const options = computed(() =>
  activeEmbedConfig.value != null && nodeKey.value != null
    ? props.getMenuOptions(
        activeEmbedConfig.value as TEmbedConfig,
